...
function OrderPlacedEmailComponent ({ order, shippingAddress, preview = 'Your order has been placed!' }: OrderPlacedTemplateProps) {
  return (
...
export const orderPlacedEmail = (props: OrderPlacedTemplateProps) => (
